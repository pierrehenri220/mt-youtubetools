...
sub _build_page {
    ...
    if ($content =~ /\[youtube https:\/\/www\.youtube\.com\/.*?list\=\w+\]/g) {
        $content =~ s/\[youtube https:\/\/www\.youtube\.com\/.*?list\=(\w+)\]/<div class\=\"asset-video youtube-asset"><iframe width\=\"560\" height\=\"315\" src\=\"https\:\/\/www\.youtube-nocookie\.com\/embed\/videoseries\?list=$1&rel\=0\" frameborder=\"0\" allow=\"autoplay; encrypted-media\" allowfullscreen><\/iframe><\/div>/g;
